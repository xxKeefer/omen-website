...
<Callout emoji="✨" color="pink.700" heading="The Black Medusa's Scene Concept">
    Stony Stare:{' '}
    <em>
...
<Callout emoji="✨" color="pink.700" heading="Generic Example Routine">
    <ul>
...
<Callout emoji="✨" color='pink.700' heading="Example Defense Concepts">
    <ul>
        <li>
